...
Subject::Subject(const string& name):subject(subject){}
...
Section::Section(const string& name):section(section){}
...
void week_day::addSlot(const slot& new_slot){
    slots.push_back(new_slot);
}
vector<slot> week_day::get_slots(const Section& section, 
...
int program_control::add_teacher(const string& name, 
...
int program_control::add_section(const string& name, 
                           const Subject& subject){
